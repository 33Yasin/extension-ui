...
const SwitchButton = ({checked, onChange}: SwitchButtonProps) => {
  return (
    <label className="relative inline-block w-9 h-5 cursor-pointer">
        ...
        />
        <span className="absolute top-0 left-0 right-0 bottom-0 bg-neutral-600 rounded-full transition-colors duration-300 peer-checked:bg-red-700 dark:peer-checked:bg-red-400"></span>
